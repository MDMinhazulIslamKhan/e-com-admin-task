...
const Cart = () => {
    ...
    return (
        <>
            <Meta title='E-commerce - My cart' />
            <div className="overflow-x-auto w-full">
                {all_product?.length !== 0 && <h1 className='text-center text-lg sm:text-2xl mb-5 font-bold'><Link href='/' className="btn btn-outline font-bold relative bottom-1 btn-sm">Click</Link> Here to Add More Product.</h1>}
